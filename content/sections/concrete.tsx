...
export default function Concrete() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Concrete</h2>

      <p className="text-base leading-relaxed">The square footage of <strong>porches</strong>, <strong>garages</strong>, and <strong>the</strong> <strong>living area</strong> are provided in the title section of your corresponding plan's PDF drawing. These values are used to calculate concrete quantities for the estimate.</p>
      ...
      <p className="text-base leading-relaxed">Transfer this information over to the appropriate cells in the <strong>Concrete</strong> section of estimating spreadsheet. Each area type has its own input field.</p>
