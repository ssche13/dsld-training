...
export default function ExteriorInteriorFootings() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Exterior and Interior Footings</h2>

      <p className="text-base leading-relaxed">This is the final foundation estimate. It captures <strong>all footings — both exterior and interior</strong> — using color-coded lines to distinguish between the two types.</p>

      <h3 className="font-medium text-lg text-dsld-text">Louisiana and Texas Plans</h3>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li>All footings marked <strong>I</strong> on the PDF drawing will be traced in <strong><ColorWord c="yellow">yellow</ColorWord></strong> (interior footings).</li>

        <li>All other marked footings will be traced in <strong><ColorWord c="red">red</ColorWord></strong> (exterior footings).</li>

      </ul>

      <p className="text-base leading-relaxed">Where possible, one footing should never intersect another footing. A gap should always be between two separate footings to ensure every corner is accounted for without double-estimating.</p>

      <CmsImage src="/images/cms/exterior-interior-footings--course_0.png" alt="Louisiana and Texas Plans – example 1" />

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li>Use <strong>TLEN</strong> to get the <strong>total linear footage</strong> of the <strong><ColorWord c="red">red</ColorWord></strong> and <strong><ColorWord c="yellow">yellow</ColorWord></strong> lines, respectively.</li>

        <li>Round up the totals, then place the <strong><ColorWord c="red">red</ColorWord></strong> quantities into the <strong>Exterior Footings </strong>cell and the <strong><ColorWord c="yellow">yellow</ColorWord></strong> quantities into the<strong> Interior Footings</strong> cell under the Concrete header. .</li>
      ...
      <p className="text-base leading-relaxed">Mississippi and South Alabama plans require concrete footings to be broken down further than Louisiana and Texas plans. This is what an MS/SAL concrete footing estimate looks like in the spreadsheet:</p>
      ...
      <p className="text-base leading-relaxed">As mentioned before, your lines will be executed the same as Louisiana and Texas, but the color of your lines will match the cells in your MS/SAL spreadsheet. Your CAD lines should look like this:</p>
      ...
      <p className="text-base leading-relaxed">Concrete footings in Florida, North Alabama, and Tennessee are taken off using third-party engineering plans from Wilson Lumber. As mentioned above, the logic for drawing the CAD lines is the same across all regions. You will use engineering to determine which interior walls are load bearing for footings.</p>
      ...
      <p className="text-base leading-relaxed">North Alabama and Tennessee require no extra steps once the interior load bearing walls are determined.</p>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li>
          Use <strong><ColorWord c="red">red</ColorWord></strong> lines for exterior footings and <strong><ColorWord c="yellow">yellow</ColorWord></strong> lines for interior footings, get the <strong>total linear footage</strong>, then input the quantities into their respective cells in the spreadsheet.
          <CmsImage src="/images/cms/exterior-interior-footings--course_6.png" alt="Florida, North Alabama, and Tennessee Plans – example 2" />
          <p className="mt-2 text-base leading-relaxed">Florida breaks concrete footings down similar to Mississippi and North Alabama.</p>
      ...
      <p className="text-base leading-relaxed">Your lines in AutoCAD for Florida, North Alabama, and Tennessee will be executed the same, but color-coded differently.</p>
