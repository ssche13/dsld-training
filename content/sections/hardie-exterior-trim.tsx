...
export default function HardieExteriorTrim() {
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-lg text-dsld-teal">Hardie and Exterior Trim</h2>

      <Note>Hardie and exterior trim will only be taken off in Louisiana and Texas.</Note>

      <h3 className="font-medium text-base text-dsld-text">Soffit</h3>

      <p className="text-sm leading-relaxed">Soffit is the horizontal surface that runs underneath the roof’s overhang. The overhang size determines whether <strong>6&quot;</strong>, <strong>12&quot;</strong>, or <strong>16&quot; soffit</strong> is used.</p>
      ...
      <p className="text-sm leading-relaxed">Copy your drip edge sketch off to the side and adjust with the following colors:</p>

      <ul className="list-disc pl-6 space-y-2 text-sm">

        <li><strong>Orange</strong> - 12x12 Non-Vented Soffit (gables/dormers with brick cladding)</li>

        <li><strong>Red</strong> - 12x12 Vented Soffit (where brick is located on the perimeter of the home, usually already drawn from your drip edge sketch)</li>

        <li><strong>Cyan</strong> - 16x12 Non-Vented Soffit (gables/dormers with any other cladding besides brick)</li>

        <li><strong>White</strong> - 16x12 Vented Soffit (where porches are located or the perimeter with any other cladding besides brick)</li>
      ...
      <h3 className="font-medium text-base text-dsld-text">Fascia</h3>

      <p className="text-sm leading-relaxed">Fascia will run everywhere soffit is installed, both vented and non-vented. Fascia is the vertical board that covers the end of roof rafters. <strong>1x6x12 Cement Smooth Trim</strong> pieces are needed around the perimeter of the home.</p>
      ...
      <p className="text-sm leading-relaxed">Example: 180 ft total drip edge → 180*1.1 / 12 = 15 + 1 = 18 pieces of 1x6x12 Cement Smooth Trim.</p>

      <CmsImage src="/images/cms/hardie-exterior-trim--course_3.png" alt="Fascia – example 1" />

      <h3 className="font-medium text-base text-dsld-text">Birdboxes</h3>

      <p className="text-sm leading-relaxed">Birdboxes provide a solid, finished backing for trim and siding to terminate against. 4 boxes come from one piece of <strong>1x12x12 Cement Smooth Trim</strong>.</p>
      ...
      <p className="text-sm leading-relaxed">Example: 6 birdboxes → 6 / 4 = 1.5 → 2 pieces</p>

      <h3 className="font-medium text-base text-dsld-text">Board and Batten Flashing</h3>

      <CmsImage src="/images/cms/hardie-exterior-trim--course_6.png" alt="Board and Batten Flashing – example 1" />

      <p className="text-sm leading-relaxed">Board and Batten walls may require flashing.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Board and Batten Sheets</h3>

      <p className="text-sm leading-relaxed">Board and Batten sheets are count items.</p>

      <ul className="list-disc pl-6 space-y-2 text-sm">

        <li>Copy over your Board and Batten polylines off to the side, excluding anything traced in yellow.</li>
      ...
      <h3 className="font-medium text-base text-dsld-text">Board and Batten Strips</h3>

      <p className="text-sm leading-relaxed">Board and Batten strips also need to be accounted for.</p>
      ...
      <p className="text-sm leading-relaxed">This is needed for windows, doors, vents, garages, corners, and beams.</p>
      ...
      <p className="text-sm leading-relaxed">You will only insert a count in the 5/6x4x12 cell if you're dealing with windows that have less than 6'' of separation between them. The separation will be handled by the <strong>5/6x4x12 Cement Smooth Trim</strong>.</p>
      ...
      <p className="text-sm leading-relaxed">This is for<strong> lapped siding only.</strong></p>
      ...
      <h3 className="font-medium text-base text-dsld-text">1x4x12 Cement Primed Smooth</h3>

      <p className="text-sm leading-relaxed"><strong>1x4x12 Cement Primed Smooth</strong> is used to connect the porch to the soffit where there is <strong>stucco</strong> or <strong>brick cladding</strong> <strong>only</strong>.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Drop Beams - Non-Vented Soffit</h3>

      <p className="text-sm leading-relaxed">The outside of the beam gets covered with <strong>12”x12’ Non-Vented Cement Soffit Smooth</strong> and the inside of the beam gets covered with <strong>16”x12’ Non-Vented Cement Soffit Smooth</strong>.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Drop Beams - Cement Smooth Trim</h3>

      <p className="text-sm leading-relaxed">Hardie uses the <strong>5/4x4x12 Fiber Cement Smooth Trim</strong> on the front and back of beams.</p>
      ...
      <p className="text-sm leading-relaxed">For the bottom of Hardie beams, we use <strong>6 1/4x12 Smooth Fiber Cement Siding</strong>.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Vinyl Posts – Cement Smooth Trim</h3>

      <p className="text-sm leading-relaxed">For the Hardie wrap around the post, cement smooth trim is needed.</p>
      ...
      <p className="text-sm leading-relaxed">Hardie post caps and bases need <strong>5/4 8x12 Fiber Cement Smooth Trim</strong>.</p>
      ...
      <p className="text-sm leading-relaxed">Tapered posts have a gradual decrease in diameter from the top to the bottom, or vice versa.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Exterior Trim</h3>

      <p className="text-sm leading-relaxed">Exterior trim quantities will be pulled directly from the information inputted from the previous section.</p>

      <CmsImage src="/images/cms/hardie-exterior-trim--course_25.png" alt="Exterior Trim – example 1" />

      <p className="text-sm leading-relaxed">Notice how each cell has a description. Use the lines and polylines drawn in AutoCAD from previous calculations to fill in the corresponding cells that apply to your plan.</p>
    </div>
  );
}
