...
export default function FlashingDoorsWindows() {
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-lg text-dsld-teal">Galvanized Steel Flashing</h2>

      <p className="text-sm leading-relaxed">Galvanized steel flashing protects the home from water infiltration at critical points.</p>

      <Note>Galvanized steel flashing is not taken off in Florida, North Alabama, or Tennessee.</Note>

      <h3 className="font-medium text-base text-dsld-text">5/8&quot; – Doors and Windows</h3>

      <p className="text-sm leading-relaxed">5/8&quot; galvanized steel flashing is used for all window and door flashing.</p>

      <ul className="list-disc pl-6 space-y-2 text-sm">

        <li>Get the <strong>total linear footage</strong> of the doors traced in <strong>yellow</strong>.</li>
      ...
      <h3 className="font-medium text-base text-dsld-text">1&quot; – Water Tables</h3>

      <p className="text-sm leading-relaxed">1&quot; galvanized steel flashing is used for <strong>water tables only.</strong></p>
