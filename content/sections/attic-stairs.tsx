...
export default function AtticStairs() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Attic Stairs</h2>

      <p className="text-base leading-relaxed">Attic stairs (also called attic access or pull-down stairs) provide access to the attic space. They are counted from the <strong>floor plan</strong> and typically appear as a dashed rectangle labeled with the attic stair callout.</p>

      <CmsImage src="/images/cms/attic-stairs--course_0.png" alt="Attic Stairs – example 1" />

      <p className="text-base leading-relaxed"><strong>Locating Attic Stairs</strong></p>

      <p className="text-base leading-relaxed">Go to the floor plan in the PDF drawing.</p>
      ...
      <p className="text-base leading-relaxed">For plans calling for the attic stairs in air-conditioned spaces, an <strong>Attic Ladder Insulator</strong> and is required when the attic access is in an air-conditioned space.</p>
