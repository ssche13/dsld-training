  ...
  return (
    <div className="space-y-4">
      ...
      <ol className="list-decimal pl-6 space-y-1 text-sm">
        <li>Select &apos;Open a project&apos; in AutoCAD. AutoCAD&apos;s Project Browser window should pop up, and you will click the following icon: <ImagePlaceholder label="Project Browser Folder" /></li>
        <li>Navigate as follows: Desktop &gt; AutoCAD Architecture-Projects &gt; 01 AutoCAD Projects.</li>
        <li>Refer to the PDF plan drawing for the Plan Family name in the title section, then find that corresponding name in the 01 AutoCAD Projects folder. <strong><u>NOTE:</u></strong> Plan family names will not always match the name of the plan name itself. <ImagePlaceholder label="Plan Family" /></li>
        <li>Navigate as follows: Plan Family Name &gt; Plan Family Name (yes, again) &gt; Plan Family Project link. Select the project link and open the file. <ImagePlaceholder label="Plan Family Project Link" /></li>
