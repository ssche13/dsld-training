...
export default function HipsRidgesValleys() {
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-lg text-dsld-teal">Hips, Ridges, &amp; Valleys</h2>

      <p className="text-sm leading-relaxed">Use the<strong> Roof Check </strong>lines you traced previously along with the roof plan of the PDF to complete this section. Recall that hips, ridges, and valleys on the roof plan are represented by the following colors, so each type is easy to identify:</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">Reading the Roof Plan Page</h3>

      <p className="text-sm leading-relaxed">On the <strong>Roof Plan</strong> of the PDF, numbers inside circles represent the length of that run. If a number has <strong>two circles</strong> around it, you need <strong>two pieces</strong> of that size.</p>
      ...
      <p className="text-sm leading-relaxed">Refer to the call outs on the PDF drawing representing <strong>the lengths of the hips on pitch</strong>.</p>
      ...
      <h3 className="font-medium text-base text-dsld-text">2x8’s</h3>

      <p className="text-sm leading-relaxed">Refer to the same call outs on the PDF drawing to <strong>count</strong> how many 2x8s are represented at each pitch length. This count will include <strong>all 3</strong> roof elements.</p>
      ...
      <p className="text-sm leading-relaxed">You will need to refer to the engineering plans to determine the count of hips, ridges, and valleys, along with the length of hips and ridges for starter shingles. Hips, ridges, and valleys can come in either <strong>2x8’s or 2x10’s</strong> in these regions.</p>
