...
export default function Beams() {
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-lg text-dsld-teal">Beams</h2>

      <p className="text-sm leading-relaxed">Beams are primary structural horizontal members spanning openings and carrying loads. Accurate beam measurement requires careful reading of the project files provided for all regions.</p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-sm">
        ...
        <li>
          ...
          <p className="mt-2 leading-relaxed">Bethel Engineering calls out where stud locations are and how many need to be at each location.</p>
        </li>
      ...
      <h3 className="font-medium text-base text-dsld-text">Raw Beam Counts</h3>

      <p className="text-sm leading-relaxed">The logic is the same for each region: simply count how many of each beam is present and enter the quantities into the spreadsheet.</p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-sm">
        ...
        <li>
          <strong>MS/SAL</strong>
          <p className="mt-2 leading-relaxed">Beam callouts in these regions do not include the length. You will need to use <strong>MEASURE</strong> in Foxit PDF Editor to get the length of each beam.</p>
          <CmsImage src="/images/cms/beams--course_5.png" alt="Raw Beam Counts – example 2" />
        </li>

        <li>
          <strong>FL/NAL/TN</strong>
          <p className="mt-2 leading-relaxed">Exact beam sizes and quantities are <strong>given</strong> in these regions through a legend. Simply transfer this information over to the spreadsheet.</p>
          <CmsImage src="/images/cms/beams--course_6.png" alt="Raw Beam Counts – example 3" />
          <p className="mt-2 leading-relaxed">Attics receive <strong>1 2x12x10 </strong>for all regions.</p>
        </li>
      ...
      <h3 className="font-medium text-base text-dsld-text">Parts List</h3>

      <p className="text-sm leading-relaxed">You may notice that this part of the spreadsheet is filled with <strong>placeholders.</strong> This is because beams that match what is called out on the plans often must be added to the spreadsheet from the <strong>parts list.</strong></p>
      ...
      <p className="text-sm leading-relaxed">Refer to this section from other modules if you need help navigating an item you cannot find already listed within the takeoff spreadsheet.</p>
    </div>
  );
}
