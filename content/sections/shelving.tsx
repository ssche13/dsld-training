...
export default function Shelving() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm leading-relaxed">Shelving includes wood shelving installed in closets, pantries, and laundry rooms. It is important that you use the <strong>Closet Elevations</strong> on the<strong> Finishes</strong> page of the PDF plan drawing for this section.</p>

      <p className="text-sm leading-relaxed">Estimation</p>

      <CmsImage src="/images/cms/shelving--course_0.png" alt="Shelving – example 1" />

      <p className="text-sm leading-relaxed">Color-coded lines are used to depict the different shelf types:</p>

      <ul className="list-disc pl-6 space-y-2 text-sm">

        <li><strong>Red</strong> = Shelf</li>

        <li><strong>Cyan </strong>= Rod</li>

        <li><strong>Green</strong> = Shelf Support</li>

      </ul>

      <p className="text-sm leading-relaxed">Use the closet elevations to aid in drawing your color-coded lines.</p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-sm">
        ...
        <li>Count the <strong>green</strong> lines and place them here:</li>
      ...
      <ul className="list-disc pl-6 space-y-2 text-sm">
        ...
        <li>Count the <strong>red </strong>lines and place them here:</li>
      ...
      <ul className="list-disc pl-6 space-y-2 text-sm">
        ...
        <li>Count the <strong>cyan</strong> lines and place them here:</li>
      ...
      <p className="text-sm leading-relaxed">Add a standard count of <strong>3</strong> to the 1x12x16 MDF quantity for all two-story homes.</p>
    </div>
  );
}
