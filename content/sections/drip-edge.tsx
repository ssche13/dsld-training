...
export default function DripEdge() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Drip Edge</h2>

      <p className="text-base leading-relaxed"><strong>Drip edge</strong> is metal flashing installed at roof edges to direct water away from the fascia and into gutters, preventing wood rot. The <strong>fascia</strong> is the vertical board capping where the gutters attach, while the <strong>soffit</strong> is the underside paneling connecting the fascia to the house.</p>

      <h3 className="font-medium text-lg text-dsld-text">Starter Shingles</h3>

      <p className="text-base leading-relaxed"><strong>Trace all drip edges</strong> on the roof plan using the <strong>LINE</strong> feature. A drip edge is any part of the roof that meets soffit. <strong>Always trace where gables or dormers are present.</strong></p>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li><strong><ColorWord c="green">Green</ColorWord></strong> = 16&quot; overhang</li>

        <li><strong><ColorWord c="red">Red</ColorWord></strong> = 12&quot; overhang</li>

        <li><strong><ColorWord c="yellow">Yellow</ColorWord></strong> = 6&quot; overhang</li>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Bell Overhang</h3>

      <p className="text-base leading-relaxed">A bell overhang is an aesthetic feature where a roof gently curves outward at the bottom edge, resembling a bell.</p>
      ...
      <p className="text-base leading-relaxed">To calculate the linear footage of a bell overhang, use the <strong>LINE</strong> feature to trace where the overhang is present on your roof plan.</p>

      <CmsImage src="/images/cms/drip-edge--course_4.png" alt="Bell Overhang – example 2" />

      <p className="text-base leading-relaxed">Get the <strong>total linear footage</strong> of the lines drawn, round up, and insert the quantity into the <strong>2x4</strong> cell of the spreadsheet.</p>
