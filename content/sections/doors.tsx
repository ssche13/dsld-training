...
export default function Doors() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Doors</h2>

      <p className="text-base leading-relaxed">Door estimation uses the <strong>door schedule</strong> from the plan set. The schedule provides each door mark, size, and type (interior/exterior).</p>

      <CmsImage src="/images/cms/doors--course_0.png" alt="Doors – example 1" />

      <h3 className="font-medium text-lg text-dsld-text">Reading the Door Schedule</h3>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Interior Doors</h3>

      <p className="text-base leading-relaxed">Keep a tally of door sizes and whether they are <strong>left-hand </strong>or <strong>right-hand. </strong>Include double doors in your tally, where they count as 1.</p>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Exterior Doors</h3>

      <p className="text-base leading-relaxed">Repeat the same process you did for the interior doors.</p>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Garage Doors</h3>

      <p className="text-base leading-relaxed">Repeat the same process.</p>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Door Hardware</h3>

      <p className="text-base leading-relaxed">Door hardware is referenced on the <strong>finishes</strong> page of the PDF.</p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-base">
        ...
        <li>Each home is allotted <strong>5</strong> for the <strong><ColorWord c="black">Black</ColorWord> Aluminum House Number</strong>.</li>

      </ul>

      <CmsImage src="/images/cms/doors--course_8.png" alt="Black Aluminum House Number – example 1" />

      <h3 className="font-medium text-lg text-dsld-text">Shower Doors</h3>

      <p className="text-base leading-relaxed">Shower door information can be found on the <strong>floor plan</strong> of the PDF.</p>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Casing – LA ONLY</h3>

      <p className="text-base leading-relaxed">Exterior doors and interior garage doors require casing to cover gaps between the door frame and adjacent walls.</p>
