...
export default function Porches() {
  return (
    <div className="space-y-4">
      ...
      <CmsImage src="/images/cms/porches--docx_0.png" alt="Porches CAD" />

      <ul className="list-disc pl-6 space-y-1 text-sm">
        <li>Count the boxes, then place that count in <strong>4x8-1/4&quot; Beaded Cement Soffit</strong> cell of the spreadsheet.</li>
      </ul>

      <CmsImage src="/images/cms/porches--porches_0.png" alt="Beaded Soffit XL" />
      ...
      <CmsImage src="/images/cms/porches--porches_1.png" alt="1x4 porches" />
