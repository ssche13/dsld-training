...
export default function Porches() {
  return (
    <div className="space-y-5">
      ...
      <h3 className="font-medium text-lg text-dsld-text">Mississippi Plans</h3>

      <p className="text-base leading-relaxed">Porches are taken off by calculating the total linear footage of the porch interiors.</p>
