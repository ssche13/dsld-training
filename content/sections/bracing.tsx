...
export default function Bracing() {
  return (
    <div className="space-y-5">
      ...
      <p className="text-base leading-relaxed">If you zoom into the roof framing layout in AutoCAD or the PDF, you will see circles with an 'X' in them. We address these separately as follows: circles <strong>with a tail</strong> and circles <strong>with no tail</strong>.</p>

      <CmsImage src="/images/cms/bracing--course_6.png" alt="Louisiana and Texas Plans – example 7" />

      <p className="text-base leading-relaxed">You will also notice lines running through some of these circles, indicated as <strong>purlins.</strong></p>

      <p className="text-base leading-relaxed">To begin, we will estimate using the circles that fall on purlins first.</p>
      ...
      <Note>Notice how there is a <ColorWord c="white">white</ColorWord> line at the bottom point instead of the usual <ColorWord c="pink">pink</ColorWord> dashed line that indicates the plate height. There will be scenarios where you will have to add a line for the specified plate height of the elevation you’re working on yourself.</Note>
      ...
      <p className="text-base leading-relaxed">The linear footage you will record next to each circle will be <strong>color-coded</strong> as follows to match the spreadsheet:</p>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li><strong><ColorWord c="yellow">Yellow</ColorWord></strong> - 8' and below</li>

        <li><strong><ColorWord c="white">White</ColorWord></strong> - 10'</li>

        <li><strong><ColorWord c="red">Red</ColorWord></strong> - 12'</li>

        <li><strong><ColorWord c="orange">Orange</ColorWord></strong> - 14'</li>

        <li><strong><ColorWord c="green">Green</ColorWord></strong> - 16'</li>

        <li><strong><ColorWord c="purple">Purple</ColorWord></strong> - 18'</li>

        <li><strong><ColorWord c="cyan">Cyan</ColorWord></strong> - 20'</li>
      ...
      <p className="text-base leading-relaxed">Let's move onto <strong>individual circles that do not fall on any purlins,</strong> starting with circles with no tail.</p>
      ...
      <p className="text-base leading-relaxed">You will use similar steps for individual circles with a tail that do not fall on purlins.</p>
      ...
      <p className="text-base leading-relaxed">Once you have recorded a measurement for each brace onto your roof framing layout copy, you are ready to start entering into the spreadsheet.</p>
      ...
      <p className="text-base leading-relaxed">The set-up and estimation logic will be the same as Louisiana and Texas, but you will use <strong>PDFIMPORT</strong> to insert the roof framing page from Bethel Engineering for accurate calculations. <strong>Be sure to download the engineering plans to your computer before you begin setting up AutoCAD.</strong></p>
