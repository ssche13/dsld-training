  ...
  return (
    <div className="space-y-5">
      ...
      <ul className="list-disc pl-6 space-y-2 text-base">
        ...
        <li>Cladding square footage</li>

        <li>Perimeter of windows</li>

        <li>Header material</li>

        <li>OSB</li>

        <li>Ceiling joists</li>

        <li>Additional lumber for stairs (if applicable)</li>

        <li>Hips, ridges, and valleys</li>

        <li>Hangers</li>

        <li>Decking and felt</li>

        <li>Standard shingles and flashing</li>

        <li>Metal roof accetns</li>
        ...
        <li>Fypon vents and brackets</li>

        <li>Miscellaneous material (rain windows and blinds)</li>
