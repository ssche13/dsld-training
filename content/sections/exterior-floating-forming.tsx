...
export default function ExteriorFloatingForming() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Exterior and Floating Forming</h2>

      <p className="text-base leading-relaxed">This section measures two forming values: the <strong>exterior forming perimeter</strong> and the <strong>floating (interior) forming</strong>. Exterior forming is a temporary formwork on the perimeter to shape poured concrete. Floating forming is a technique where formwork “floats” or moves continuously on top of a soft surface.</p>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Exterior Forming</h3>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li>Use <strong>POLYLINE</strong> to trace a <strong><ColorWord c="red">red</ColorWord></strong> line along the <strong>outside perimeter</strong> of the foundation plan.</li>
      ...
      <h3 className="font-medium text-lg text-dsld-text">Floating Forming</h3>

      <ul className="list-disc pl-6 space-y-2 text-base">

        <li>Use <strong>POLYLINE</strong> to trace a <strong><ColorWord c="yellow">yellow</ColorWord></strong> line along <strong>interior porch walls</strong>.</li>

        <li>Include walls that border the garage and interior of the home.</li>

        <li>Use <strong>TLEN</strong> to get the <strong>total linear footage</strong> of the <strong><ColorWord c="yellow">yellow</ColorWord></strong> lines.</li>
