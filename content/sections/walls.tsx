...
export default function Walls() {
  return (
    <div className="space-y-5">
      <h2 className="font-semibold text-xl text-dsld-teal">Walls</h2>

      <p className="text-base leading-relaxed">Wall measurements are one of the <strong>most detailed parts</strong> of the estimate. You will trace both interior and exterior walls in AutoCAD to calculate the total linear footage quantities that feed into framing, sheetrock, and other trades. In Louisiana and Texas, you will refer to the ceiling framing layout in the PDF plan drawing for help with this section. <strong>For all other regions, the engineering plans will take precedence as your reference.</strong></p>

      <h3 className="font-medium text-lg text-dsld-text">Regular Walls &amp; Knee Walls</h3>

      <p className="text-base leading-relaxed">Regular walls are standard full-height walls. Knee walls are shorter walls — commonly found in attic spaces, bonus rooms, and at kitchen bars. Knee walls are also used to step up walls to catch beams or ceiling joists. Both must be measured accurately because they affect framing lumber and sheetrock quantities.</p>

      <h3 className="font-medium text-lg text-dsld-text">Identifying Wall Heights and Types</h3>

      <p className="text-base leading-relaxed">There will be common scenarios where you will trace a wall that has rooms on either side of it at different ceiling heights. <strong>Pay attention to all ceiling height callouts.</strong></p>

      <p className="text-base leading-relaxed">Keep these important notes in mind. We will use a wall that has a 10' room and a 9' room on either side of it as an example:</p>
      ...
      <p className="text-base leading-relaxed">These regions utilize truss framing, so <strong>knee walls will not be taken off.</strong> Instead, truss s<strong>tep-ups</strong> are used to make up the difference between ceiling heights. Because of this, you will check engineering to determine where the trusses are spanning. You will <strong>always</strong> go with the higher ceiling height if there are rooms with trusses landing on either side of a wall at different heights.</p>
      ...
      <p className="text-base leading-relaxed">Knee walls have 2 separate places in the spreadsheet. The total linear footage for <strong>knee walls in kitchen bars</strong> will go here:</p>

      <CmsImage src="/images/cms/walls--course_5.png" alt="Calculation – example 3" />

      <p className="text-base leading-relaxed">The total linear footage for <strong>knee walls to make up differences in regular walls</strong> will go here:</p>
      ...
      <p className="text-base leading-relaxed">Random lumber is needed where stairs are present. For this step, you will use the stair section in the PDF plan drawing <strong>for all regions</strong>.</p>
