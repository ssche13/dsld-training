  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm leading-relaxed">
        Lapped Siding, Board and Batten, and Cedar Shakes will be in the same section of the spreadsheet.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-1 text-sm">
        ...
        <li>Do the same for Board and Batten and Cedar Shakes (if applicable).</li>
      ...
      <ul className="list-disc pl-6 space-y-1 text-sm">
        ...
        <li>Repeat the process you did for the porches, draw 4x8 boxes to fill in the board and batten areas you traced. Consider the waste factor that is left over from boxes that exceed the area of the traced sheets so that you are not over-estimating.</li>
      ...
      <ul className="list-disc pl-6 space-y-1 text-sm">
        <li>Copy over your Board and Batten polylines off to the side once again, <strong>this time including doors but excluding windows or vents.</strong></li>
      ...
      <ul className="list-disc pl-6 space-y-1 text-sm">
        <li>Use <strong>LINE</strong> in a color of your choice to trace along the perimeter of windows, doors, and vents once again. <strong>For the sides,</strong> trace <u>inside</u> of the trim. <strong>For the tops and bottoms,</strong> trace <u>outside</u> of the trim. <strong>For windows with 6&quot; or less separation between them,</strong> treat the perimeter as <strong>one</strong> window and trace the separation between the two in a <u>different color</u>.</li>
