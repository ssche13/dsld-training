...
export default function Siding() {
  return (
    <div className="space-y-4">
      <h2 className="font-semibold text-lg text-dsld-teal">Siding/Hardie/Board and Batten</h2>

      <p className="text-sm leading-relaxed"><strong>Lapped siding</strong>, <strong>board and batten</strong>, and <strong>cedar shakes</strong> will be in the same section of the spreadsheet.</p>
