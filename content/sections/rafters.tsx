...
export default function Rafters() {
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm leading-relaxed">Rafters are the sloped framing members that form the roof structure. Estimation includes counting common rafters, hip rafters, valley rafters, and jack rafters as shown on the <strong>roof plan.</strong></p>
      ...
      <p className="text-sm leading-relaxed">You will follow the same logic for counting rafters, except you will use the engineering plans as your reference.</p>
